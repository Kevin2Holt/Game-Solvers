...
def get_word_list():
	...
	cursor = conn.cursor()
	cursor.execute("SELECT word, squaredle FROM eng ORDER BY squaredle ASC")
...
def main():
	grid = []
	# with open('C:/Users/kevin/OneDrive/Desktop/input.txt', 'r') as file:
	...
	try:
		...
		print("Error with Previous Bonus Words of the Day")
